    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 gap-4">
            ...
            <div class="hidden sm:flex items-center gap-6">
                ...
                <a href="{{ route('pelanggan.rekomendasi.index') }}" class="text-gray-500 hover:text-blue-600 transition relative" title="Rekomendasi Bahan Pintar">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <button class="flex items-center gap-1.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 px-2.5 py-1 rounded-full transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
                            ...
                            <span class="text-xs font-semibold text-gray-700 hidden lg:block">Guest</span>
                            <svg class="w-3.5 h-3.5 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>
                        @endauth
                    </x-slot>
                    <x-slot name="content">
                        ...
                        @else
                        <x-dropdown-link :href="route('login')" class="text-sm py-1.5">{{ __('Masuk') }}</x-dropdown-link>
                        <x-dropdown-link :href="route('register')" class="text-sm py-1.5">{{ __('Daftar') }}</x-dropdown-link>
                        @endauth
                    </x-slot>
                </x-dropdown>
            </div>
            ...
            <div class="flex items-center sm:hidden gap-4">
                <a href="{{ route('pelanggan.rekomendasi.index') }}" class="text-gray-500 relative">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                </a>
