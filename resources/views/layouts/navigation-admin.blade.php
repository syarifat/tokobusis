<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm relative z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition">
                        ...
                        <span class="font-black text-xl tracking-wider text-gray-800">PANEL ADMIN</span>
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden absolute w-full left-0 bg-white border-b border-gray-200 shadow-lg">
