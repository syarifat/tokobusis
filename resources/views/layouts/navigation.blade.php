<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    @php
        $dashboardRoute = Auth::user()->role === 'admin' ? route('admin.dashboard') : route('pelanggan.dashboard');
        $isActive = Auth::user()->role === 'admin' ? request()->routeIs('admin.dashboard') : request()->routeIs('pelanggan.dashboard');
    @endphp
